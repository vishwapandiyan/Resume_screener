...
try:
    from config import NVIDIA_API_KEY as CONFIG_NVIDIA_API_KEY, LLAMA_API_KEY as CONFIG_LLAMA_API_KEY
except ImportError:
    CONFIG_NVIDIA_API_KEY = None
    CONFIG_LLAMA_API_KEY = None
...
def initialize_models():
    ...
    try:
        ...
        api_key = (os.environ.get('NVIDIA_API_KEY') or 
                  os.environ.get('LLAMA_API_KEY') or 
                  CONFIG_NVIDIA_API_KEY or 
                  CONFIG_LLAMA_API_KEY)
        ...
        if api_key:
            ...
            print("✅ LLaMA client initialized with API key")
        else:
            print("⚠️ No LLaMA API key found. Set NVIDIA_API_KEY or LLAMA_API_KEY environment variable or check config.py")
            llama_client = None
    except Exception as e:
